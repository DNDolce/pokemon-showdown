...
export const Rulesets: import('../sim/dex-formats').FormatDataTable = {
	...
	otlcube: {
		...
		ruleset: [
			...
			'-Released', '-Unreleased', '-Unobtainable', '-Nonexistent', '-terastallization',
			'-toxic', '-scald', '-defog', '-rapidspin', '-stickyweb', '-stealthrock', '-spikes', '-toxicspikes',
			'-Eviolite', '-Heavy-duty boots',
			'+Salazzle + toxic', '+Simipour + scald', '+Vullaby + defog', '+Illumise + defog', '+Whimsicott + defog', 
			'+Vespiquen + defog','+Claydol + rapidspin', '+Morpeko + rapidspin', '+Coalossal + rapidspin', '+Tatsugiri + rapidspin',
			'+Cradily + stealthrock', '+Stunfisk-Galar + stealthrock', '+Mawile + stealthrock', '+Golisopod + spikes', 
			'+Cofagrigus + toxicspikes', '+Garbodor + toxicspikes', '+Vullaby + Eviolite', '+Gligar + Eviolite',
			'+Centiskorch + Heavy-Duty Boots',

			'+Froslass', '+Archeops', '+Fezandipiti', '+Sigilyph', '+Marowak-Alola', '+Lanturn','+Decidueye',
			'+Bewear', '+Mega Camerupt', '+Duraludon', '+Ribombee', '+Qwilfish-Hisui','+Mega Audino','+Claydol',
			'+Morpeko','+Cradily','+Veluza','+Noivern','+Pinsir','+Lucario','+Crabominable','+Houndoom','+Zygarde-10%',
			'+Weezing-Galar','+Avalugg-Hisui','+Golisopod','+Arboliva','+Togedemaru','+Vullaby','+Dachsbun',
			'+Rotom-Frost','+Salazzle','+Calyrex','+Zoroark-Hisui','+Stunfisk-Galar','+Simipour','+Illumise',
			'+Virizion','+Druddigon','+Dragalge','+Gligar','+Coalossal','+Vikavolt','+Empoleon','+Articuno','+Zangoose',
			'+Palossand','+Slowbro-Galar','+Pangoro','+Klawf','+Sableye','+Centiskorch','+Gallade','+Tatsugiri',
			'+Golem-Alola','+Mawile','+Tsareena','+Glaceon','+Tyrantrum','+Heliolisk','+Delphox','+Quagsire',
			'+Whimsicott','+Magneton','+Sneasel','+Toxicroak','+Vespiquen','+Cofagrigus','+Braviary','+Garbodor',
			'+Lokix','+Lunatone','+Poliwrath','+Entei','+Dugtrio-Alola','+Mimikyu','+Drampa','+Mega Abomasnow',
		],
